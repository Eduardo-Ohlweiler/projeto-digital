        ...
        <footer>
            <section className="info">
                <ul className="apresentacao">
                    <li><h1><img src= {logoBranco} alt="logo digital branca" /></h1></li>
                    <li> <p>Diuly Moreira <br /> 
                        Eduardo Rodrigo Ohlweiler <br />
                        Fernando Marques <br/>
                        Neto Castro</p>
                    </li>
                    <li className="rsociais">
                        <a href="#"><img src= {insta} alt="logo insta" /></a>
                        <a href="#"><img src= {face} alt="logo face" /></a>
                        <a href="#"><img src= {twiter} alt="logo X" /></a>
                    </li>
                </ul>

                <ul className="informacao">
                    <li><h3>Informação</h3></li>
